...
export default function typ() {
  ...
  return (
    <div className="flex justify-center items-center flex-col max-w-[1296px] gap-y-96 ">
      <motion.div
      ...
      >
        {box1.map((_, i) => (
          <motion.div
            ...
            className="h-[497px] w-[1296px] rounded-[28px] flex text-6xl justify-center items-center text-company-blue-black bg-white"
          >
            Hello
          </motion.div>
        ))}
      ...
      >
        {box2.map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="h-[350px] w-[636px] rounded-[28px] flex text-6xl justify-center items-center text-company-blue-black bg-white"
          >
            Hello
          </motion.div>
        ))}
      ...
      >
        {box3.map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="h-[350px] w-[416px] rounded-[28px] flex text-5xl justify-center items-center text-company-blue-black bg-white"
          >
            Hello
          </motion.div>
        ))}
      ...
      >
        {box4.map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="h-[196px] w-[196px] rounded-[16px] flex text-4xl justify-center items-center text-company-blue-black bg-white"
          >
            Hello
          </motion.div>
        ))}
      ...
      >
        {box5.map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="h-[86px] w-[86px] rounded-[16px] flex text-2xl justify-center items-center text-company-blue-black bg-white"
          >
            Hello
          </motion.div>
        ))}
      ...
      >
        {box4.map((_, i) => (
          <motion.div
            key={i}
            variants={itemVariants}
            className="h-[86px] w-[196px] rounded-[16px] flex text- justify-center items-center text-company-blue-black bg-white"
          >
            Hello
          </motion.div>
        ))}
      ...
      <p className={text.cardDisplaytext}>
        Card Display Text - The quick brown fox jumps over the lazy dog.
      </p>
      ...
      <button className={text.secondaryButtontext}>Secondary Button</button>
    </div>
    </div>
      </div>
    </div>
