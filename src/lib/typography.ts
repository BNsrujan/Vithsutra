// const text = {
//   Displaytext:
//     "text-[96px] sm:text-[140px] md:text-[90px] lg:text-[100px] xl:text-[100px] leading-[1] tracking-tighter font-semibold  text-wrap",
...
//   Sectiontexthead:
//     "text-[30px] sm:text-[48px] md:text-[56px] lg:text-[64px] leading-[1em] tracking-tight font-semibold  text-wrap",

//   Sectionbodytext:
//     "text-[16px] sm:text-[22px] md:text-[24px]  lg:text-[28px] leading-[1em]  font-bold  text-wrap",

//   Extratext:
//     "text-[16px] sm:text-[22px] md:text-[24px] lg:text-[28px] leading-[1em]  font-extralight    text-wrap",
...
//   Navtext:
//     "text-[10px] sm:text-[12px] md:text-[16px] font-semibold font-[500] text-wrap",

//   FooterHeadingtext:
//     "text-[10px] sm:text-[12px] md:text-[12px] leading-[1.5em] tracking-[0.8] md:tracking-[0.01em] font-bold text-black/70 max-w-[600px] mb-[2.6px]  text-wrap",

//   Footerlinktext:
//     "text-[10px] sm:text-[12px] md:text-[1rem] leading-[1em] tracking-[0.8em] md:tracking-[0.01em] font-semibold text-black/50  text-wrap",
...
//   secondaryButtontext:
//     "text-[12px] sm:text-[13px] md:text-[14px] font-bold leading-[1.5] tracking-[0.02em] sm:tracking-[0.025em] md:tracking-[0.03em]  text-wrap",

//   inputplaceholdertext:
//     "text-[14px] sm:text-[15px] md:text-[16px] tracking-[0.04em] md:tracking-[0.08em] text-justify  text-wrap",
// };
