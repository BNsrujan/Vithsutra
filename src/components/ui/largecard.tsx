        ...
        <motion.div
            ...
            >
              ...
              <div className="absolute inset-0 p-4 sm:p-6 md:p-8 flex flex-col justify-end">
                ...
                >
                  <h3 className={`${text.Sectionprefixtext} text-company-white-text ${isTouched ? 'text-company-white-text' : 'group-hover:text-company-white-text'} transition-all duration-700 ease-in-out`}>
                    {feature.title}
                  </h3>
                  <p className={`${text.DisplayPrefixtext} text-clip h-4 md:h-full md:w-full w-80 sm:w-full text-company-light-gray ${isTouched ? 'text-company-white-text' : 'group-hover:text-company-white-text'} transition-all duration-700 ease-in-out`}>
                    {feature.description}
                  </p>
                </motion.div>
