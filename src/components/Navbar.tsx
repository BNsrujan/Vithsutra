...
const menuData: Record<string, MenuSection> = {
  projects: {
    ...
    items: [
      ...
      { title: "Hydroponics Controller ", description: "Precision-controlled farming using industrial-grade sensors and real-time dashboards", href: "/products/billing-system" },
