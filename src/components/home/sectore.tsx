  ...
  return (
    <div className=" py-16 max-w-[1400px]  h-screen flex flex-col  justify-center items-center text-company-black">
      <div className="m mx-auto">
        ...
        <h1 className={`${text.Sectiontext}text-company-black mb-4`}>
          Automation at All Levels
        </h1>

        <div className="mt-8 grid grid-cols-1  lg:grid-cols-3 gap-3.5 ">
          {features.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                key={feature.title}
                className="bg-company-light-light-gray w-[var(--box-small-square-width)] border  h-[var(--box-small-square-height)] p-15  rounded-[28px] relative"
              >
                <div className="mb-4">
