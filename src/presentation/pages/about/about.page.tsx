...
const gridItems = [
  ...
  {
    id: 2,
    image: "/application_image_iiot/Smart-robots.jpg",
  ...
  {
    id: 4,
    image: "/application_image_iiot/Industrial-Automation.jpg",
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-[40%] p-8 lg:p-16 flex flex-col items-center lg:items-start justify-center bg-white">
          ...
          <div className="max-w-[400px] space-y-8">
            ...
            >
              We are a team of innovators and engineers dedicated to
              transforming industries through cutting-edge IIoT and robotics
              solutions. Our mission is to bridge the gap between traditional
              manufacturing and the future of smart automation, creating
              sustainable and efficient industrial ecosystems.
            </motion.p>
